...
//==============================================================================
bool CEntity::OnLoad(char* File, int Width, int Height, int MaxFrames, SDL_Renderer* MainRenderer ) {
...
//------------------------------------------------------------------------------
void CEntity::OnRender(SDL_Renderer* Surf_Display) {
    if(Surf_Entity == NULL || Surf_Display == NULL) return;

     
     CSurface::OnDraw(Surf_Display, Surf_Entity, X - CCamera::CameraControl.GetX(), Y - CCamera::CameraControl.GetY(), Anim_Control.GetCurrentFrame() * Width, (CurrentFrameRow) * Height, Width, Height);
}

//------------------------------------------------------------------------------
void CEntity::OnCleanup() {
    if(Surf_Entity) {
        SDL_DestroyTexture(Surf_Entity);
    }
...
if(SpeedX < 2.0f && SpeedX > -2.0f && SpeedY < 2.0f && SpeedY > -2.0f) {
AccelX = 0;
SpeedX = 0;
AccelY = 0;
SpeedY = 0;
